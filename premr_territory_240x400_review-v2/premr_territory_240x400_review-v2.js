...
lib.ssMetadata = [
		{name:"premr_territory_240x400_review_v2_atlas_", frames: [[242,0,240,400],[0,0,240,400]]}
];
...
(lib.BG2 = function() {
	this.initialize(ss["premr_territory_240x400_review_v2_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.premr_territory_240x400_reviewv2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"premr_territory_240x400_review_v2_atlas_.png", id:"premr_territory_240x400_review_v2_atlas_"}
	],
	preloads: []
};
