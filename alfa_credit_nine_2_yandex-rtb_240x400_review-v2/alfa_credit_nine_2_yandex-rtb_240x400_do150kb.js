...
lib.ssMetadata = [
		{name:"alfa_credit_nine_2_yandex_rtb_240x400_do150kb_atlas_", frames: [[0,330,499,141],[0,473,201,206],[0,0,433,328]]}
];
...
(lib.clouds = function() {
	this.initialize(ss["alfa_credit_nine_2_yandex_rtb_240x400_do150kb_atlas_"]);
	this.gotoAndStop(0);
...
(lib.TXT02 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(0.3,17.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-57.3,-109.7,114.9,229.3);
...
(lib.TXT01 = function(mode,startPosition,loop) {
	...
	// Layer 2 copy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#E4362E").s().p("");
	this.shape.setTransform(0.6,28.35);
	...
	this.shape_1.setTransform(1.025,-81.425);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-77.6,-112.9,155.8,236.60000000000002);
...
(lib.legal_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-102,-300);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-102,-300,201,206);
...
(lib.BG = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(120,229.525);
...
(lib.CLOUDS = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:1},410).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-359},410).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-610,-71,1219,141);
...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(121,345);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(411));

	// LOGO
	this.instance_1 = new lib.ALFALOGO();
	this.instance_1.parent = this;
	this.instance_1.setTransform(83,34);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(411));

	// MAN
	this.instance_2 = new lib.MAN();
	this.instance_2.parent = this;
	this.instance_2.setTransform(150,246);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(254).to({x:290,y:296},39,cjs.Ease.cubicInOut).to({_off:true},1).wait(117));

	// CLOUD
	this.instance_3 = new lib.CLOUDS("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(151.5,361.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(136).to({_off:false},0).to({x:72},39,cjs.Ease.quartInOut).wait(79).to({startPosition:0},0).to({x:-213},39,cjs.Ease.cubicInOut).wait(118));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({_off:false},0).to({x:65},37,cjs.Ease.cubicInOut).wait(80).to({startPosition:0},0).to({x:-220},39,cjs.Ease.quartInOut).wait(236));

	// BG
	this.instance_7 = new lib.BG();
	this.instance_7.parent = this;
	this.instance_7.setTransform(120,189.5,1,1,0,0,0,120,229.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(411));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-458.5,-40,1223.5,500);


// stage content:
(lib.alfa_credit_nine_2_yandexrtb_240x400_do150kb = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(21.5,160,739,271.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"alfa_credit_nine_2_yandex_rtb_240x400_do150kb_atlas_.png", id:"alfa_credit_nine_2_yandex_rtb_240x400_do150kb_atlas_"}
	],
	preloads: []
};
