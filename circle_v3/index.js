...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[398,564,86,54],[335,564,61,79],[0,282,540,280],[0,0,540,280],[0,564,333,137]]}
];
...
}).prototype = getMCSymbolPrototype(lib.legal_1, new cjs.Rectangle(-244,-140,333,137), null);
...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({x:270,alpha:1,startPosition:24,loop:false},24,cjs.Ease.cubicOut).wait(95).to({mode:"single",startPosition:59},0).to({x:294,alpha:0},24,cjs.Ease.cubicIn).to({_off:true},1).wait(264));
