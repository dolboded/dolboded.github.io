...
p.nominalBounds = new cjs.Rectangle(0,0,339,155);// helper functions:
...
(lib.legal_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-245,-144);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.legal_1, new cjs.Rectangle(-245,-144,339,155), null);
