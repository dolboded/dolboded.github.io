...
(lib.TextTwoPrice = function(mode,startPosition,loop) {
	...
	// Layer 1 copy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFF100").s().p("AgcAuIAAgEIAfgsQAGgJABgGQAAgFgDgDQgDgDgEAAQgDAAgEADQgDACAAAHIgQAAQAAgOAHgHQAIgIALAAQANAAAHAIQAHAHAAAMQgBAMgJAJIgDAFIgGAJIgIAMIAdAAIAAARg");
	this.shape.setTransform(79.1,-5.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFF100").s().p("");
	this.shape_1.setTransform(10.5,-0.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhbApQgRgPAAgaQAAgYARgPQAQgPAXAAQAXAAARAPQAPAOAAAZQAAAagOAPQgRAOgXAAQgXAAgRgOgAhGgTQgHAHAAAMQAAANAHAIQAIAIAKAAQALAAAHgIQAIgIAAgNQABgMgIgHQgIgIgKAAQgLAAgIAIgAAwA1IAAhNIggAAIAAgbIBcAAIAAAbIgfAAIAABNg");
	this.shape_2.setTransform(-70.8,2.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-84.7,-15.4,169.4,30.9);
...
(lib.TextBathFour = function(mode,startPosition,loop) {
	...
	// Layer 1 copy
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFF100").ss(2,0,1).p("AgagPIATAAAguAQIAUAAIAVAAIA0AAAgtgOIATAA");
	this.shape.setTransform(48.4,1.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFF100").s().p("");
	this.shape_1.setTransform(14,-0.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhbApQgQgPgBgaQABgYAQgPQAQgPAXAAQAXAAARAPQAPAOAAAZQAAAagPAPQgQAOgXAAQgXAAgRgOgAhFgTQgIAHAAAMQAAANAIAIQAHAIALAAQAKAAAIgIQAHgIABgNQAAgMgIgHQgHgIgLAAQgLAAgHAIgAAwA1IAAhNIggAAIAAgbIBdAAIAAAbIggAAIAABNg");
	this.shape_2.setTransform(-46.3,2.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-60,-15.4,120.1,30.9);
...
(lib.bath_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-120,-74.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-120,-74.5,240,149);
...
(lib.btn = function(mode,startPosition,loop) {
	...
	this.instance_1 = new lib.buttonHit();
	this.instance_1.setTransform(0,0,1.08,1.08);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance,p:{scaleX:1,scaleY:1}}]}).to({state:[{t:this.instance,p:{scaleX:1.08,scaleY:1.08}}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance,p:{scaleX:1,scaleY:1}}]},1).wait(1));
...
(lib.movie = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_425 = new cjs.Graphics().p("AmGKRQiiiiAAjlQAAjmCiigQCiiiDkAAQDlAACiCiQCiCgAADmQAADliiCiQiiCijlAAQjkAAiiiig");
	var mask_graphics_504 = new cjs.Graphics().p("AmGKRQiiiiAAjlQAAjmCiigQCiiiDkAAQDlAACiCiQCiCgAADmQAADliiCiQiiCijlAAQjkAAiiiig");
	var mask_graphics_505 = new cjs.Graphics().p("AmLKTQikikAAjpQAAjoCkiiQCkilDnAAQDoAACkClQCkCiAADoQAADpikCkQikCkjoAAQjnAAikikg");
	var mask_graphics_506 = new cjs.Graphics().p("AmUKWQioioAAjuQAAjuCoimQCoioDsAAQDuAACnCoQCoCmAADuQAADuioCoQinCojuAAQjsAAioiog");
	var mask_graphics_507 = new cjs.Graphics().p("AmaKXQiqiqAAjxQAAjxCqioQCrirDvAAQDwAACrCrQCqCoAADxQAADxiqCqQirCqjwAAQjvAAiriqg");
	var mask_graphics_508 = new cjs.Graphics().p("AmYKWQipipAAjwQAAjwCpinQCqiqDuAAQDvAACqCqQCpCnAADwQAADwipCpQiqCqjvAAQjuAAiqiqg");
	var mask_graphics_509 = new cjs.Graphics().p("AmRKUQimimAAjsQAAjsCmikQCninDqAAQDrAACnCnQCmCkAADsQAADsimCmQinCnjrAAQjqAAining");
	var mask_graphics_510 = new cjs.Graphics().p("AmCKQQigigAAjkQAAjjCgieQCgigDiAAQDjAACgCgQCgCeAADjQAADkigCgQigCgjjAAQjiAAigigg");
	var mask_graphics_511 = new cjs.Graphics().p("AlnKIQiWiVAAjUQAAjTCWiUQCViVDSAAQDTAACVCVQCWCUAADTQAADUiWCVQiVCVjTAAQjSAAiViVg");
	var mask_graphics_512 = new cjs.Graphics().p("Ak7J7QiDiDAAi5QAAi6CDiDQCDiAC4AAQC5AACDCAQCDCDAAC6QAAC5iDCDQiDCDi5AAQi4AAiDiDg");
	var mask_graphics_513 = new cjs.Graphics().p("AjAJkQhjhiAAiMQAAiLBjhjQBihiCKAAQCLAABjBiQBiBjAACLQAACMhiBiQhjBjiLAAQiKAAhihjg");
	var mask_graphics_514 = new cjs.Graphics().p("ACRIqQgQgQAAgXQAAgXAQgQQAQgRAXAAQAXAAAQARQAQAQAAAXQAAAXgQAQQgQAQgXAAQgXAAgQgQg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(425).to({graphics:mask_graphics_425,x:42.5,y:82}).wait(79).to({graphics:mask_graphics_504,x:42.5,y:82}).wait(1).to({graphics:mask_graphics_505,x:42.5,y:82.3}).wait(1).to({graphics:mask_graphics_506,x:42.5,y:83}).wait(1).to({graphics:mask_graphics_507,x:42.5,y:83.3}).wait(1).to({graphics:mask_graphics_508,x:42.5,y:83.2}).wait(1).to({graphics:mask_graphics_509,x:42.5,y:82.7}).wait(1).to({graphics:mask_graphics_510,x:42.5,y:81.7}).wait(1).to({graphics:mask_graphics_511,x:42.5,y:79.8}).wait(1).to({graphics:mask_graphics_512,x:42.5,y:76.6}).wait(1).to({graphics:mask_graphics_513,x:38.1,y:71.1}).wait(1).to({graphics:mask_graphics_514,x:24,y:57.1}).wait(1).to({graphics:null,x:0,y:0}).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(427).to({_off:false},0).wait(1).to({regX:0.8,regY:1.9,x:99.6,y:93.6,alpha:0.406},0).wait(1).to({x:77.4,alpha:0.637},0).wait(1).to({x:64.3,alpha:0.774},0).wait(1).to({x:55.8,alpha:0.862},0).wait(1).to({x:50.2,alpha:0.921},0).wait(1).to({x:46.5,alpha:0.96},0).wait(1).to({x:44.2,alpha:0.983},0).wait(1).to({x:43,alpha:0.996},0).wait(1).to({regX:0,regY:0,x:41.8,y:91.7,alpha:1},0).wait(69).to({regX:0.8,regY:1.9,scaleX:1.01,scaleY:1.01,x:42.6,y:93.3},0).wait(1).to({scaleX:1.04,scaleY:1.04,x:42.7,y:93},0).wait(1).to({regX:0,regY:0,scaleX:1.05,scaleY:1.05,x:41.8,y:90.8},0).wait(1).to({regX:0.8,regY:1.9,scaleX:1.05,scaleY:1.05,x:42.6,y:92.8,alpha:0.995},0).wait(1).to({scaleX:1.03,scaleY:1.03,y:93.1,alpha:0.976},0).wait(1).to({scaleX:0.99,scaleY:0.99,y:93.7,alpha:0.936},0).wait(1).to({scaleX:0.92,scaleY:0.92,y:94.7,alpha:0.865},0).wait(1).to({scaleX:0.81,scaleY:0.81,y:96.4,alpha:0.745},0).wait(1).to({scaleX:0.61,scaleY:0.61,y:99.4,alpha:0.535},0).wait(1).to({regX:0.5,regY:0,scaleX:0.1,scaleY:0.1,x:42.5,y:106.9,alpha:0},0).to({_off:true},1).wait(28));
...
(lib.avant_240_400_yandex = function(mode,startPosition,loop) {
	...
	// button
	this.instance_1 = new lib.btt();
	this.instance_1.setTransform(120,200);
	new cjs.ButtonHelper(this.instance_1, 0, 1, 2, false, new lib.btt(), 3);
...
p.nominalBounds = new cjs.Rectangle(119,199,242,436);
