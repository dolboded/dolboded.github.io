...
lib.ssMetadata = [
		{name:"premr_territory_728x90_review_atlas_", frames: [[730,0,23,19],[0,0,728,90],[0,92,728,90]]}
];
...
(lib.age = function() {
	this.initialize(ss["premr_territory_728x90_review_atlas_"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.txt, new cjs.Rectangle(0,0,728,90), null);
...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(9,63);
...
p.nominalBounds = new cjs.Rectangle(0,0,729,400);


// stage content:
(lib.premr_territory_728x90_review = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(363,44,366,356);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"premr_territory_728x90_review_atlas_.png", id:"premr_territory_728x90_review_atlas_"}
	],
	preloads: []
};
