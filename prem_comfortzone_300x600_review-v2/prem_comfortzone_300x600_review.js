...
lib.ssMetadata = [
		{name:"prem_comfortzone_300x600_review_atlas_", frames: [[302,0,300,600],[0,0,300,600]]}
];
...
}).prototype = getMCSymbolPrototype(lib.LOGO, new cjs.Rectangle(0,0,300,600), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/prem_comfortzone_300x600_review_atlas_.png", id:"prem_comfortzone_300x600_review_atlas_"}
	],
	preloads: []
};
