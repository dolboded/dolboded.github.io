...
(lib.AlfaLogo = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(40.775,13.4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.AlfaLogo, new cjs.Rectangle(-49,-5,179.6,36.8), null);
...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.instance_3.setTransform(184.55,150.1,1.87,1.87,0,0,0,82.1,37.5);
	...
	this.instance_4.setTransform(184.9,162.3,1.8699,1.8699,0,0,0,82.3,37.6);
...
p.nominalBounds = new cjs.Rectangle(-55,-1467.2,1306.1,3270.5);
