...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"bgman.jpg?1525693282492", id:"bgman"},
		{src:"card.png?1525693282492", id:"card"},
		{src:"legal.png?1525693282492", id:"legal"}
	]
};
...
(lib.man = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFFFFF","rgba(255,255,255,0)"],[0,1],38.6,99,105.7,118.6).s().p("A4+X+MAAAgv7MAx9AAAMAAAAv7g");
...
p.nominalBounds = new cjs.Rectangle(-26,-388,624,307);
...
(lib.bgman_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(199,-96);
...
p.nominalBounds = new cjs.Rectangle(-28.9,-388,627,466.1);
...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.instance_6.setTransform(173,30);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({regX:284.5,regY:-154.9,x:420.3,y:-124.9,startPosition:1},0).wait(1).to({x:397.7,startPosition:2},0).wait(1).to({x:380.9,startPosition:3},0).wait(1).to({x:367.6,startPosition:4},0).wait(1).to({x:356.6,startPosition:5},0).wait(1).to({x:347.3,startPosition:6},0).wait(1).to({x:339.4,startPosition:7},0).wait(1).to({x:332.6,startPosition:8},0).wait(1).to({x:326.7,startPosition:9},0).wait(1).to({x:321.5,startPosition:10},0).wait(1).to({x:317.1,startPosition:11},0).wait(1).to({x:313.2,startPosition:12},0).wait(1).to({x:309.9,startPosition:13},0).wait(1).to({x:307,startPosition:14},0).wait(1).to({x:304.6,startPosition:15},0).wait(1).to({x:302.6,startPosition:16},0).wait(1).to({x:301,startPosition:17},0).wait(1).to({x:299.7,startPosition:18},0).wait(1).to({x:298.7,startPosition:19},0).wait(1).to({x:298,startPosition:20},0).wait(1).to({x:297.6,startPosition:21},0).wait(1).to({regX:0,regY:0,x:13,y:30,startPosition:18},0).to({_off:true},88).wait(249));
...
p.nominalBounds = new cjs.Rectangle(-138,-449,909,703);


// stage content:
(lib.alfa_mastercard_cashback_man_728x90v2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(363,-113,892,466.1);
