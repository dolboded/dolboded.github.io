...
p.nominalBounds = new cjs.Rectangle(-126,-17,135.6,31.3);
...
(lib.txt0204 = function(mode,startPosition,loop) {
	...
	// Layer 1 copy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EF3124").s().p("");
	this.shape.setTransform(-130.4,-5.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-158,-43.2,216.8,86.5);
...
p.nominalBounds = new cjs.Rectangle(-81.6,37.2,168.5,29.7);
...
p.nominalBounds = new cjs.Rectangle(-92.3,-17.6,184.6,35.2);
...
(lib.txt0103 = function(mode,startPosition,loop) {
	...
	// Layer 1 copy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EF3124").s().p("");
	this.shape.setTransform(-0.7,2.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-58.4,-17.6,116.9,35.2);
...
(lib.txt0102 = function(mode,startPosition,loop) {
	...
	// Layer 1 copy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EF3124").s().p("");
	this.shape.setTransform(0.6,-0.8);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-80.3,-17.6,160.6,35.2);
...
(lib.man = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFFFFF","rgba(255,255,255,0)"],[0,1],-2.9,72.5,-2.9,142.5).s().p("A4/X+MAAAgv7MAx/AAAMAAAAv7g");
...
p.nominalBounds = new cjs.Rectangle(-160,-361.9,320,543);
...
p.nominalBounds = new cjs.Rectangle(-32,-25,64,49.8);
...
p.nominalBounds = new cjs.Rectangle(-104,-74,207,147);
...
(lib.divider = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF2D1E").s().p("AgEGxIAAthIAJAAIAANhg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-0.5,-43.3,1,86.8);
...
p.nominalBounds = new cjs.Rectangle(-91,-28,181,115);
...
(lib.butt = function(mode,startPosition,loop) {
	...
	// Layer 2 copy 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-0.5,-1.4);
...
(lib.blank = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AifGmIAAtLIE/AAIAANLg");
	this.shape.setTransform(0.7,0,7.465,4.739);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-119.2,-199.9,240,400);
...
(lib.logo_mastercard_move = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#1B1819").s().p("");
...
p.nominalBounds = new cjs.Rectangle(-293.6,-361.9,455.9,543);
...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.instance_6.setTransform(23,30);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({regX:-65.7,regY:-90.5,x:-42.8,y:-60.5,startPosition:1},0).wait(1).to({x:-43,startPosition:2},0).wait(1).to({x:-43.4,startPosition:3},0).wait(1).to({x:-44.1,startPosition:4},0).wait(1).to({x:-45.1,startPosition:5},0).wait(1).to({x:-46.7,startPosition:6},0).wait(1).to({x:-48.4,startPosition:7},0).wait(1).to({x:-50,startPosition:8},0).wait(1).to({x:-51.2,startPosition:9},0).wait(1).to({x:-51.9,startPosition:10},0).wait(1).to({x:-52.4,startPosition:11},0).wait(1).to({x:-52.6,startPosition:12},0).wait(1).to({regX:0,regY:0,x:13,y:30,startPosition:13},0).to({_off:true},97).wait(249));
...
(lib.alfa_mastercard_cashback_man_240x400v2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(-30.7,68.1,455.9,543);
