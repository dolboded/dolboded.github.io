...
lib.ssMetadata = [
		{name:"premr_territory_728x90_review_v2_atlas_", frames: [[0,0,728,90],[0,92,728,90]]}
];
...
(lib.BG2 = function() {
	this.initialize(ss["premr_territory_728x90_review_v2_atlas_"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.txt_1, new cjs.Rectangle(-1,-1,728,90), null);
...
}).prototype = getMCSymbolPrototype(lib.fade, new cjs.Rectangle(0,0,728,90), null);
...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:121,y:201,alpha:0},14).wait(16));

	// txt
	this.instance_1 = new lib.txt_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(121,201,1,1,0,0,0,120,200);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({alpha:1},15).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,0,729,91);


// stage content:
(lib.premr_territory_728x90_reviewv2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"premr_territory_728x90_review_v2_atlas_.png", id:"premr_territory_728x90_review_v2_atlas_"}
	],
	preloads: []
};
