...
(lib.LOGOWHITE = function(mode,startPosition,loop) {
	...
	// flash0.ai
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(64.175,2.35);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.LOGOWHITE, new cjs.Rectangle(-1,-11,130.4,51.8), null);
...
(lib.LOGORED2 = function(mode,startPosition,loop) {
	...
	// flash0.ai
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EF3124").s().p("");
	this.shape.setTransform(64.175,2.35);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.LOGORED2, new cjs.Rectangle(-1,-11,130.4,51.8), null);
