...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"alfabank_card_728x90_yandex_do150kb_atlas_.png", id:"alfabank_card_728x90_yandex_do150kb_atlas_"}
	]
};
...
lib.ssMetadata = [
		{name:"alfabank_card_728x90_yandex_do150kb_atlas_", frames: [[0,0,868,90],[0,92,474,71]]}
];
...
(lib.bg = function() {
	this.spriteSheet = ss["alfabank_card_728x90_yandex_do150kb_atlas_"];
	this.gotoAndStop(0);
...
(lib.white = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(244.5,-154.5,3.046,0.228);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-121,-200,731,91.1);
...
(lib.man = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-170,-200);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-170,-200,868,90);
...
(lib.legal_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(116,-202);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(116,-202,474,71);
...
(lib.text2 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("EgsegBlMBY9AAAIAADLMhY9AAAg");
	mask.setTransform(180.2,-22.3);

	// t2_5
	this.instance = new lib.t2_5();
	this.instance.setTransform(393,-44.4);
	this.instance._off = true;

	this.instance.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(10).to({_off:false},0).wait(1).to({regX:-3,regY:-0.3,x:390,y:-37.9},0).wait(1).to({y:-33.5},0).wait(1).to({y:-30.3},0).wait(1).to({y:-28},0).wait(1).to({y:-26.2},0).wait(1).to({y:-24.8},0).wait(1).to({y:-23.8},0).wait(1).to({y:-23.1},0).wait(1).to({y:-22.6},0).wait(1).to({y:-22.3},0).wait(1).to({regX:0,regY:0,x:393,y:-22},0).wait(51));

	// t2_4
	this.instance_1 = new lib.t2_4();
	this.instance_1.setTransform(263,-45.4);
	this.instance_1._off = true;

	this.instance_1.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(8).to({_off:false},0).wait(1).to({regX:1.9,regY:0.2,x:264.9,y:-38.4},0).wait(1).to({y:-34},0).wait(1).to({y:-30.8},0).wait(1).to({y:-28.5},0).wait(1).to({y:-26.7},0).wait(1).to({y:-25.3},0).wait(1).to({y:-24.3},0).wait(1).to({y:-23.6},0).wait(1).to({y:-23.1},0).wait(1).to({y:-22.8},0).wait(1).to({regX:0,regY:0,x:263,y:-23},0).wait(53));

	// t2_3
	this.instance_2 = new lib.t2_3();
	this.instance_2.setTransform(162,-45.4);
	this.instance_2._off = true;

	this.instance_2.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(4).to({_off:false},0).wait(1).to({regX:-2.5,regY:0.3,x:159.5,y:-38.3},0).wait(1).to({y:-33.9},0).wait(1).to({y:-30.7},0).wait(1).to({y:-28.4},0).wait(1).to({y:-26.6},0).wait(1).to({y:-25.2},0).wait(1).to({y:-24.2},0).wait(1).to({y:-23.5},0).wait(1).to({y:-23},0).wait(1).to({y:-22.7},0).wait(1).to({regX:0,regY:0,x:162,y:-23},0).wait(57));

	// t2_2
	this.instance_3 = new lib.t2_2();
	this.instance_3.setTransform(47,-45.4);
	this.instance_3._off = true;

	this.instance_3.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({_off:false},0).wait(1).to({regX:0.8,regY:0.3,x:47.8,y:-38.3},0).wait(1).to({y:-33.9},0).wait(1).to({y:-30.7},0).wait(1).to({y:-28.4},0).wait(1).to({y:-26.6},0).wait(1).to({y:-25.2},0).wait(1).to({y:-24.2},0).wait(1).to({y:-23.5},0).wait(1).to({y:-23},0).wait(1).to({y:-22.7},0).wait(1).to({regX:0,regY:0,x:47,y:-23},0).wait(59));

	// t2_1
	this.instance_4 = new lib.t2_1();
	this.instance_4.setTransform(-54,-45.4);

	this.instance_4.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({regX:-3.8,regY:0.1,x:-57.8,y:-38.5},0).wait(1).to({y:-34.1},0).wait(1).to({y:-30.9},0).wait(1).to({y:-28.6},0).wait(1).to({y:-26.8},0).wait(1).to({y:-25.4},0).wait(1).to({y:-24.4},0).wait(1).to({y:-23.7},0).wait(1).to({y:-23.2},0).wait(1).to({y:-22.9},0).wait(1).to({regX:0,regY:0,x:-54,y:-23},0).wait(61));
...
(lib.text_3 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(52).to({graphics:mask_graphics_52,x:429.7,y:-40}).wait(122));

	// t3_10_GIFTS
	this.instance = new lib.t3_10();
	this.instance.setTransform(470.5,-20.1);
	this.instance._off = true;

	this.instance.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(55).to({_off:false},0).wait(1).to({regY:-0.1,y:-28},0).wait(1).to({y:-32.1},0).wait(1).to({y:-34.9},0).wait(1).to({y:-37},0).wait(1).to({y:-38.4},0).wait(1).to({y:-39.5},0).wait(1).to({y:-40.3},0).wait(1).to({y:-40.8},0).wait(1).to({y:-41.1},0).wait(1).to({regY:0},0).wait(109));

	// t3_9_OTHER
	this.instance_1 = new lib.t3_9();
	this.instance_1.setTransform(383.5,-20.1);
	this.instance_1._off = true;

	this.instance_1.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(52).to({_off:false},0).wait(1).to({regX:-0.1,regY:1.6,x:383.4,y:-26.3},0).wait(1).to({y:-30.4},0).wait(1).to({y:-33.2},0).wait(1).to({y:-35.3},0).wait(1).to({y:-36.7},0).wait(1).to({y:-37.8},0).wait(1).to({y:-38.6},0).wait(1).to({y:-39.1},0).wait(1).to({y:-39.4},0).wait(1).to({regX:0,regY:0,x:383.5,y:-41.1},0).wait(112));

	// t3_8_0
	this.instance_2 = new lib.t3_8();
	this.instance_2.setTransform(333.7,-43.9,0.2,0.2,0,0,0,0.3,0.3);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(40).to({_off:false},0).wait(1).to({regX:-0.1,regY:-0.2,scaleX:0.22,scaleY:0.22,x:333.6,y:-44},0).wait(1).to({scaleX:0.3,scaleY:0.3},0).wait(1).to({scaleX:0.44,scaleY:0.44,x:333.5,y:-44.1},0).wait(1).to({scaleX:0.65,scaleY:0.65,y:-44.2},0).wait(1).to({scaleX:0.86,scaleY:0.86,x:333.4},0).wait(1).to({scaleX:1.01,scaleY:1.01,y:-44.3},0).wait(1).to({scaleX:1.08,scaleY:1.08,x:333.3},0).wait(1).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:333.7,y:-43.9},0).wait(1).to({regX:-0.1,regY:-0.2,scaleX:1.08,scaleY:1.08,x:333.6,y:-44.1},0).wait(1).to({scaleX:1.02,scaleY:1.02},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:333.7,y:-43.9},0).wait(123));

	// t3_7_0
	this.instance_3 = new lib.t3_7();
	this.instance_3.setTransform(317.7,-43.9,0.2,0.2,0,0,0,0.3,0.3);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(38).to({_off:false},0).wait(1).to({regX:-0.1,regY:-0.2,scaleX:0.22,scaleY:0.22,x:317.6,y:-44},0).wait(1).to({scaleX:0.3,scaleY:0.3},0).wait(1).to({scaleX:0.44,scaleY:0.44,x:317.5,y:-44.1},0).wait(1).to({scaleX:0.65,scaleY:0.65,y:-44.2},0).wait(1).to({scaleX:0.86,scaleY:0.86,x:317.4},0).wait(1).to({scaleX:1.01,scaleY:1.01,y:-44.3},0).wait(1).to({scaleX:1.08,scaleY:1.08,x:317.3},0).wait(1).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:317.7,y:-43.9},0).wait(1).to({regX:-0.1,regY:-0.2,scaleX:1.08,scaleY:1.08,x:317.6,y:-44.1},0).wait(1).to({scaleX:1.02,scaleY:1.02},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:317.7,y:-43.9},0).wait(125));

	// t3_6_3
	this.instance_4 = new lib.t3_6();
	this.instance_4.setTransform(301.7,-43.9,0.2,0.2,0,0,0,0.3,0.3);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(36).to({_off:false},0).wait(1).to({regX:-0.3,regY:-0.2,scaleX:0.22,scaleY:0.22,x:301.6,y:-44},0).wait(1).to({scaleX:0.3,scaleY:0.3,x:301.5},0).wait(1).to({scaleX:0.44,scaleY:0.44,x:301.4,y:-44.1},0).wait(1).to({scaleX:0.65,scaleY:0.65,x:301.3,y:-44.2},0).wait(1).to({scaleX:0.86,scaleY:0.86,x:301.2},0).wait(1).to({scaleX:1.01,scaleY:1.01,y:-44.3},0).wait(1).to({scaleX:1.08,scaleY:1.08,x:301.1},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.1,scaleY:1.1,x:301.7,y:-43.8},0).wait(1).to({regX:-0.3,regY:-0.2,scaleX:1.08,scaleY:1.08,x:301.3,y:-44.1},0).wait(1).to({scaleX:1.02,scaleY:1.02},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:301.7,y:-43.9},0).wait(127));

	// t3_4_1
	this.instance_5 = new lib.t3_4();
	this.instance_5.setTransform(245.3,-44.3,0.2,0.2,0,0,0,-0.3,0.3);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(24).to({_off:false},0).wait(1).to({regX:-1.5,regY:-0.2,scaleX:0.22,scaleY:0.22,x:245,y:-44.4},0).wait(1).to({scaleX:0.31,scaleY:0.31,x:244.9},0).wait(1).to({scaleX:0.46,scaleY:0.46,x:244.7,y:-44.5},0).wait(1).to({scaleX:0.66,scaleY:0.66,x:244.4,y:-44.6},0).wait(1).to({scaleX:0.86,scaleY:0.86,x:244.2},0).wait(1).to({scaleX:1,scaleY:1,x:244,y:-44.7},0).wait(1).to({scaleX:1.08,scaleY:1.08,x:243.9},0).wait(1).to({regX:-0.1,regY:0.1,scaleX:1.1,scaleY:1.1,x:245.3,y:-44.2},0).wait(1).to({regX:-1.5,regY:-0.2,scaleX:1.08,scaleY:1.08,x:243.8,y:-44.5},0).wait(1).to({scaleX:1.02,scaleY:1.02,x:243.9},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:245.3,y:-44.3},0).wait(139));

	// mask copy 2 (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_21 = new cjs.Graphics().p("AA6g4IAAjZIblAAIAADZg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(21).to({graphics:mask_1_graphics_21,x:182.4,y:-27.4}).wait(153));

	// t3_5_OF
	this.instance_6 = new lib.t3_5();
	this.instance_6.setTransform(273.3,-20.3);
	this.instance_6._off = true;

	this.instance_6.mask = mask_1;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(34).to({_off:false},0).wait(1).to({regY:-0.1,y:-28.2},0).wait(1).to({y:-32.3},0).wait(1).to({y:-35.1},0).wait(1).to({y:-37.2},0).wait(1).to({y:-38.6},0).wait(1).to({y:-39.7},0).wait(1).to({y:-40.5},0).wait(1).to({y:-41},0).wait(1).to({y:-41.3},0).wait(1).to({regY:0},0).wait(130));

	// t3_3_OR
	this.instance_7 = new lib.t3_3();
	this.instance_7.setTransform(212.3,-20.3);
	this.instance_7._off = true;

	this.instance_7.mask = mask_1;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(21).to({_off:false},0).wait(1).to({regX:-0.2,regY:-0.1,x:212.1,y:-28.2},0).wait(1).to({y:-32.3},0).wait(1).to({y:-35.1},0).wait(1).to({y:-37.2},0).wait(1).to({y:-38.6},0).wait(1).to({y:-39.7},0).wait(1).to({y:-40.5},0).wait(1).to({y:-41},0).wait(1).to({y:-41.3},0).wait(1).to({regX:0,regY:0,x:212.3},0).wait(143));

	// t3_2_MackBook
	this.instance_8 = new lib.t3_2();
	this.instance_8.setTransform(122.5,-44.4,0.2,0.2,0,0,0,-0.3,-0.3);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(10).to({_off:false},0).wait(1).to({regX:1,regY:-0.6,scaleX:0.47,scaleY:0.47,x:123,y:-44.7},0).wait(1).to({scaleX:0.63,scaleY:0.63,x:123.2,y:-44.8},0).wait(1).to({scaleX:0.74,scaleY:0.74,x:123.3},0).wait(1).to({scaleX:0.82,scaleY:0.82,y:-44.9},0).wait(1).to({scaleX:0.87,scaleY:0.87,x:123.4},0).wait(1).to({scaleX:0.92,scaleY:0.92},0).wait(1).to({scaleX:0.95,scaleY:0.95,x:123.5},0).wait(1).to({scaleX:0.97,scaleY:0.97,y:-45},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({regX:-0.3,regY:-0.3,scaleX:1,scaleY:1,x:122.2,y:-44.7},0).wait(154));
...
p.nominalBounds = new cjs.Rectangle(-200,-200,868,90);
...
(lib.logo_alpha_2 = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(81,-14,1.18,1.18);
...
(lib.frame_2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(145.8,-53.8,0.87,0.87);
	this.instance._off = true;
	...
	this.instance_1.setTransform(162.1,-95.1,0.87,0.87,0,0,0,0.1,-0.1);
...
(lib.text_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(80.9,-0.9,2,2);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(10).to({_off:false},0).wait(1).to({regX:1,regY:0.3,scaleX:1.99,scaleY:1.99,x:82.9,y:-0.3,alpha:0.008},0).wait(1).to({scaleX:1.96,scaleY:1.96,alpha:0.036},0).wait(1).to({scaleX:1.9,scaleY:1.9,x:82.8,y:-0.4,alpha:0.095},0).wait(1).to({scaleX:1.79,scaleY:1.79,x:82.7,alpha:0.197},0).wait(1).to({scaleX:1.63,scaleY:1.63,x:82.6,alpha:0.353},0).wait(1).to({scaleX:1.42,scaleY:1.42,x:82.3,y:-0.5,alpha:0.555},0).wait(1).to({scaleX:1.18,scaleY:1.18,x:82.1,y:-0.6,alpha:0.778},0).wait(1).to({regX:0,regY:0,scaleX:0.95,scaleY:0.95,x:81,y:-1,alpha:1},0).wait(1).to({regX:1,regY:0.3,scaleX:0.96,scaleY:0.96,x:81.9,y:-0.7},0).wait(1).to({scaleX:0.98,scaleY:0.98,x:82},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:80.9,y:-0.9},0).wait(31));
...
(lib.frame_3 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(85).to({_off:false},0).wait(1).to({regX:353,regY:-166.5,x:353,y:14,alpha:0.279},0).wait(1).to({y:11.2,alpha:0.454},0).wait(1).to({y:9.2,alpha:0.584},0).wait(1).to({y:7.5,alpha:0.686},0).wait(1).to({y:6.2,alpha:0.769},0).wait(1).to({y:5.1,alpha:0.836},0).wait(1).to({y:4.3,alpha:0.889},0).wait(1).to({y:3.6,alpha:0.931},0).wait(1).to({y:3.1,alpha:0.962},0).wait(1).to({y:2.8,alpha:0.983},0).wait(1).to({y:2.6,alpha:0.996},0).wait(1).to({regX:0,regY:0,x:0,y:169,alpha:1},0).wait(73).to({regX:353,regY:-166.5,x:353,y:2.4,alpha:0.994},0).wait(1).to({y:1.9,alpha:0.977},0).wait(1).to({y:1.2,alpha:0.948},0).wait(1).to({y:0.3,alpha:0.908},0).wait(1).to({y:-1,alpha:0.855},0).wait(1).to({y:-2.6,alpha:0.789},0).wait(1).to({y:-4.5,alpha:0.707},0).wait(1).to({y:-7,alpha:0.605},0).wait(1).to({y:-10.1,alpha:0.474},0).wait(1).to({y:-14.4,alpha:0.296},0).wait(1).to({regX:0,regY:0,x:0,y:145,alpha:0},0).wait(6));
	...
	this.instance_2.setTransform(405.9,1.6,0.514,1,90,0,0,0.1,-0.1);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({alpha:1},8).wait(67).to({alpha:0},9).to({_off:true},1).wait(101));

	// mastercardlogo
	this.instance_3 = new lib.mastercard();
	this.instance_3.setTransform(470,0,0.9,0.9);
	this.instance_3.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({x:472.6,alpha:0.262},0).wait(1).to({x:474.4,alpha:0.439},0).wait(1).to({x:475.7,alpha:0.572},0).wait(1).to({x:476.8,alpha:0.676},0).wait(1).to({x:477.6,alpha:0.758},0).wait(1).to({x:478.2,alpha:0.824},0).wait(1).to({x:478.8,alpha:0.877},0).wait(1).to({x:479.2,alpha:0.918},0).wait(1).to({x:479.5,alpha:0.949},0).wait(1).to({x:479.7,alpha:0.973},0).wait(1).to({x:479.9,alpha:0.988},0).wait(1).to({x:480,alpha:0.997},0).wait(1).to({alpha:1},0).wait(62).to({x:470,alpha:0},9).to({_off:true},1).wait(101));

	// logo
	this.instance_4 = new lib.logo_alpha_2("synched",0,false);
	this.instance_4.setTransform(216,20,1.26,1.26);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({regX:59.5,regY:-16.3,x:286.8,y:-0.5,alpha:0.262,startPosition:1},0).wait(1).to({x:283.9,alpha:0.439,startPosition:2},0).wait(1).to({x:281.8,alpha:0.572,startPosition:3},0).wait(1).to({x:280.1,alpha:0.676,startPosition:4},0).wait(1).to({x:278.8,alpha:0.758,startPosition:5},0).wait(1).to({x:277.8,alpha:0.824,startPosition:6},0).wait(1).to({x:276.9,alpha:0.877,startPosition:7},0).wait(1).to({x:276.3,alpha:0.918,startPosition:8},0).wait(1).to({x:275.8,alpha:0.949,startPosition:9},0).wait(1).to({x:275.4,alpha:0.973,startPosition:10},0).wait(1).to({x:275.1,alpha:0.988,startPosition:11},0).wait(1).to({x:275,alpha:0.997,startPosition:12},0).wait(1).to({regX:0,regY:0,x:200,y:20,alpha:1,startPosition:13},0).wait(62).to({startPosition:39},0).to({x:216,alpha:0},9).to({_off:true},1).wait(101));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(212.5,-30.4,296.8,61);
...
(lib.frame_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(406.1,-143.1,0.94,0.94,0,0,0,0.1,-0.1);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(86).to({_off:false},0).wait(1).to({regX:244.5,regY:-154.5,x:244.5,y:-76.7},0).wait(1).to({y:-92.4},0).wait(1).to({y:-104.4},0).wait(1).to({y:-113.8},0).wait(1).to({y:-121.3},0).wait(1).to({y:-127.4},0).wait(1).to({y:-132.5},0).wait(1).to({y:-136.7},0).wait(1).to({y:-140.2},0).wait(1).to({y:-143},0).wait(1).to({y:-145.4},0).wait(1).to({y:-147.4},0).wait(1).to({y:-149},0).wait(1).to({y:-150.4},0).wait(1).to({y:-151.5},0).wait(1).to({y:-152.3},0).wait(1).to({y:-153},0).wait(1).to({y:-153.5},0).wait(1).to({y:-153.9},0).wait(1).to({y:-154.2},0).wait(1).to({y:-154.4},0).wait(1).to({y:-154.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1));

	// white
	this.instance_2 = new lib.white();

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({regX:244.5,regY:-154.5,x:244.5,y:-154.5,alpha:0.997},0).wait(1).to({alpha:0.99},0).wait(1).to({alpha:0.976},0).wait(1).to({alpha:0.957},0).wait(1).to({alpha:0.931},0).wait(1).to({alpha:0.898},0).wait(1).to({alpha:0.858},0).wait(1).to({alpha:0.81},0).wait(1).to({alpha:0.755},0).wait(1).to({alpha:0.692},0).wait(1).to({alpha:0.623},0).wait(1).to({alpha:0.549},0).wait(1).to({alpha:0.472},0).wait(1).to({alpha:0.393},0).wait(1).to({alpha:0.317},0).wait(1).to({alpha:0.245},0).wait(1).to({alpha:0.18},0).wait(1).to({alpha:0.124},0).wait(1).to({alpha:0.078},0).wait(1).to({alpha:0.043},0).wait(1).to({alpha:0.019},0).wait(1).to({alpha:0.005},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0},0).to({_off:true},1).wait(86));
...
p.nominalBounds = new cjs.Rectangle(-121,-200,868,91.1);
...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(245).to({startPosition:39},0).wait(1).to({regX:59.5,regY:-16.3,x:-25.5,y:-156.3,alpha:0.997},0).wait(1).to({y:-156.6,alpha:0.989},0).wait(1).to({y:-157.1,alpha:0.973},0).wait(1).to({y:-158,alpha:0.948},0).wait(1).to({y:-159.1,alpha:0.912},0).wait(1).to({y:-160.8,alpha:0.863},0).wait(1).to({y:-163,alpha:0.794},0).wait(1).to({y:-166.2,alpha:0.7},0).wait(1).to({y:-170.5,alpha:0.567},0).wait(1).to({y:-177.2,alpha:0.366},0).wait(1).to({regX:0,regY:0,x:-85,y:-173,alpha:0},0).to({_off:true},1).wait(184));

	// frame_3
	this.instance_1 = new lib.frame_3("synched",0);
	this.instance_1.setTransform(-1,-157);
	this.instance_1._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(114).to({_off:false},0).wait(131).to({startPosition:131},0).wait(1).to({regX:331.8,regY:-94.3,x:330.8,y:-147.3,alpha:0.997,startPosition:132},0).wait(1).to({y:-147.6,alpha:0.989,startPosition:133},0).wait(1).to({y:-148.2,alpha:0.973,startPosition:134},0).wait(1).to({y:-149.1,alpha:0.948,startPosition:135},0).wait(1).to({y:-150.3,alpha:0.912,startPosition:136},0).wait(1).to({y:-152.1,alpha:0.863,startPosition:137},0).wait(1).to({y:-154.5,alpha:0.794,startPosition:138},0).wait(1).to({y:-157.8,alpha:0.7,startPosition:139},0).wait(1).to({y:-162.4,alpha:0.567,startPosition:140},0).wait(1).to({y:-169.4,alpha:0.366,startPosition:141},0).wait(1).to({regX:0,regY:0,x:-1,y:-88,alpha:0,startPosition:142},0).to({_off:true},1).wait(184));
...
p.nominalBounds = new cjs.Rectangle(-155,-546,902,456);
...
(lib.alfabank_card_728x90_yandex_do150kb = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(363,44,868,92);
