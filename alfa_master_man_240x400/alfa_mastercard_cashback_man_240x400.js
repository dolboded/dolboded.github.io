...
}).prototype = getMCSymbolPrototype(lib.card_1, new cjs.Rectangle(-91,-58,181,115), null);
...
(lib.logo_mastercard_move = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(88).to({_off:false},0).wait(512));
...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(21).to({_off:false},0).wait(315).to({startPosition:315},0).wait(1).to({regX:-78.6,regY:85.4,x:-65.6,y:-135.4,alpha:0.996,startPosition:316},0).wait(1).to({y:-135.2,alpha:0.984,startPosition:317},0).wait(1).to({y:-134.8,alpha:0.963,startPosition:318},0).wait(1).to({y:-134.1,alpha:0.931,startPosition:319},0).wait(1).to({y:-133.3,alpha:0.888,startPosition:320},0).wait(1).to({y:-132.1,alpha:0.83,startPosition:321},0).wait(1).to({y:-130.6,alpha:0.754,startPosition:322},0).wait(1).to({y:-128.6,alpha:0.656,startPosition:323},0).wait(1).to({y:-126,alpha:0.524,startPosition:324},0).wait(1).to({y:-122.2,alpha:0.336,startPosition:325},0).wait(1).to({regX:0,regY:0,x:13,y:-200.9,alpha:0,startPosition:326},0).wait(12));
...
p.nominalBounds = new cjs.Rectangle(-664,-331.9,845,981);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"bgman.jpg?1525442433107", id:"bgman"},
		{src:"card.png?1525442433107", id:"card"},
		{src:"legal.png?1525442433107", id:"legal"}
	],
	preloads: []
};
