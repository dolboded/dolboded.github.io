...
(lib.txt02_5 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#F50800").s().p("");
	this.shape.setTransform(-195.275,56.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer_1 copy
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F50800").s().p("");
	this.shape_1.setTransform(-148.45,57.675);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.txt02_5, new cjs.Rectangle(-224,-124.1,383.3,310.29999999999995), null);
...
(lib.txt01_percent = function(mode,startPosition,loop) {
	...
	// Layer_1 copy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F50800").s().p("");
	...
	// Layer_2 copy 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F50800").s().p("");
	this.shape_1.setTransform(-307,-110.325);
...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({scaleX:1,scaleY:1,x:36,alpha:1,startPosition:24},24).wait(95).to({startPosition:119},0).to({x:56,alpha:0,startPosition:143},24,cjs.Ease.cubicIn).to({_off:true},1).wait(264));
