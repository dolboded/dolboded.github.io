...
(lib.alfalogoanim = function(mode,startPosition,loop) {
	...
	var mask_graphics_5 = new cjs.Graphics().p("A7SCJIAAkRMAkFAAAIAAERg");
	var mask_graphics_6 = new cjs.Graphics().p("A6mCJIAAkRMAkFAAAIAAERg");
	var mask_graphics_7 = new cjs.Graphics().p("A5PCJIAAkRMAkFAAAIAAERg");
	var mask_graphics_8 = new cjs.Graphics().p("A2/CJIAAkRMAkFAAAIAAERg");
	var mask_graphics_9 = new cjs.Graphics().p("A0ECJIAAkRMAkFAAAIAAERg");
	var mask_graphics_10 = new cjs.Graphics().p("AyCCJIAAkRMAkFAAAIAAERg");
	var mask_graphics_11 = new cjs.Graphics().p("AyCCJIAAkRMAkFAAAIAAERg");
	var mask_graphics_12 = new cjs.Graphics().p("AyCCJIAAkRMAkFAAAIAAERg");
	var mask_graphics_13 = new cjs.Graphics().p("AyCCJIAAkRMAkFAAAIAAERg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(4).to({graphics:mask_graphics_4,x:-175.9,y:-1.6}).wait(1).to({graphics:mask_graphics_5,x:-174.7,y:-1.6}).wait(1).to({graphics:mask_graphics_6,x:-170.3,y:-1.6}).wait(1).to({graphics:mask_graphics_7,x:-161.6,y:-1.6}).wait(1).to({graphics:mask_graphics_8,x:-147.2,y:-1.6}).wait(1).to({graphics:mask_graphics_9,x:-128.5,y:-1.6}).wait(1).to({graphics:mask_graphics_10,x:-108,y:-1.6}).wait(1).to({graphics:mask_graphics_11,x:-86.3,y:-1.6}).wait(1).to({graphics:mask_graphics_12,x:-75.4,y:-1.6}).wait(1).to({graphics:mask_graphics_13,x:-72.4,y:-1.6}).wait(12));
...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(11).to({_off:false},0).wait(419));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(11).to({_off:false},0).wait(28).to({startPosition:28},0).wait(1).to({regX:-178.5,regY:0.6,scaleX:0.96,scaleY:0.96,x:-171.7,y:-121.4,startPosition:29},0).wait(1).to({regX:-0.1,regY:-0.1,scaleX:0.9,scaleY:0.9,x:-1.1,y:-122.1,startPosition:30},0).wait(1).to({regX:-178.5,regY:0.6,scaleX:0.9,scaleY:0.9,x:-161.9,y:-121.4,startPosition:31},0).wait(1).to({scaleX:0.91,scaleY:0.91,x:-163.3,startPosition:32},0).wait(1).to({scaleX:0.93,scaleY:0.93,x:-166.6,startPosition:33},0).wait(1).to({scaleX:0.96,scaleY:0.96,x:-172.4,y:-121.3,startPosition:34},0).wait(1).to({scaleX:0.99,scaleY:0.99,x:-177,startPosition:35},0).wait(1).to({scaleX:1,scaleY:1,x:-179,startPosition:36},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-1,y:-122,startPosition:42},0).to({_off:true},36).wait(346));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(39).to({startPosition:24},0).wait(1).to({regX:-72.5,regY:-0.2,scaleX:0.96,scaleY:0.96,x:65.9,y:140.1},0).wait(1).to({regX:0,regY:0,scaleX:0.9,scaleY:0.9,x:127,y:140},0).wait(1).to({regX:-72.5,regY:-0.2,scaleX:0.9,scaleY:0.9,x:61.9,y:139.8},0).wait(1).to({scaleX:0.91,scaleY:0.91,x:62.5},0).wait(1).to({scaleX:0.93,scaleY:0.93,x:63.8,y:139.9},0).wait(1).to({scaleX:0.96,scaleY:0.96,x:66.1,y:140.1},0).wait(1).to({scaleX:0.99,scaleY:0.99,x:68,y:140.2},0).wait(1).to({scaleX:1,scaleY:1,x:68.8},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:141.5,y:140.5},0).to({_off:true},352).wait(30));
...
// stage content:
(lib.alfa_7_240x400_review_v4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
