...
(lib.txt02_5 = function(mode,startPosition,loop) {
	...
	this.shape_1.setTransform(115.1,114.125);
	...
	this.shape_2.setTransform(-51.5875,91.875);
	...
	this.shape_3.setTransform(0.125,0.1);
...
(lib.bird2mov = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:50.5},263).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-30.5,-39.5,111,79);
...
// stage content:
(lib.alfa_credit19_nine_girl_540x280_reviewv2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
