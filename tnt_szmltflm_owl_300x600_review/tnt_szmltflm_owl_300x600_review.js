...
(lib.OWL_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.OWL_1, new cjs.Rectangle(0,0,300,600), null);
...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(150.35,181.1,1.147,1.147,0,0,0,114.5,39.3);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(220.8,31.1,1,1,0,0,0,60.8,11.1);
	...
	this.instance_5.setTransform(155,667.95,1,1,0,0,0,0.5,0.7);
...
p.nominalBounds = new cjs.Rectangle(-6.5,0,323.1,1012.6);


// stage content:
(lib.tnt_szmltflm_owl_300x600_review = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(143.5,299,173.10000000000002,713.6);
// library properties:
lib.properties = {
