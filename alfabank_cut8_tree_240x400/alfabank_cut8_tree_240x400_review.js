...
(lib.txt101 = function(mode,startPosition,loop) {
	...
	// Layer 1 copy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EF3124").s().p("");
	this.shape.setTransform(-0.1,2.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.txt101, new cjs.Rectangle(-52.1,-23.3,104.5,46.7), null);
...
(lib.sheep = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-152,-24);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.sheep, new cjs.Rectangle(-152,-24,506,265), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#FFFFFF","#D4E6F3"],[0,1],0,0,0,0,0,284.8).s().p("EhisAspMAAAhZRMDFZAAAMAAABZRg");
...
(lib.TXT1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regX:-0.1,regY:2.3,x:-0.1,y:54.7,alpha:0.536},0).wait(1).to({y:24.1,alpha:0.731},0).wait(1).to({y:6.5,alpha:0.843},0).wait(1).to({y:-4.5,alpha:0.914},0).wait(1).to({y:-11.4,alpha:0.957},0).wait(1).to({y:-15.4,alpha:0.983},0).wait(1).to({y:-17.5,alpha:0.996},0).wait(1).to({regX:0,regY:0,x:0,y:-20.4,alpha:1},0).wait(1).to({regX:-0.1,regY:2.3,x:-0.1,y:-17.6},0).wait(1).to({y:-15.9},0).wait(1).to({y:-14.1},0).wait(1).to({regX:0,regY:0,x:0,y:-16},0).wait(57).to({regX:-0.1,regY:2.3,scaleX:1,scaleY:1,x:-0.1,y:-13.7},0).wait(1).to({scaleX:1.02,scaleY:1.02,y:-13.6},0).wait(1).to({scaleX:1.05,scaleY:1.05},0).wait(1).to({regY:-0.1,scaleX:1.05,scaleY:1.05,y:-16},0).wait(1).to({regY:2.3,scaleX:1.03,scaleY:1.03,y:-13.5,alpha:0.977},0).wait(1).to({scaleX:0.98,scaleY:0.98,y:-13.7,alpha:0.894},0).wait(1).to({scaleX:0.86,scaleY:0.86,y:-13.9,alpha:0.733},0).wait(1).to({scaleX:0.7,scaleY:0.7,x:0,y:-14.3,alpha:0.5},0).wait(1).to({scaleX:0.54,scaleY:0.54,y:-14.7,alpha:0.267},0).wait(1).to({scaleX:0.42,scaleY:0.42,y:-15,alpha:0.106},0).wait(1).to({scaleX:0.37,scaleY:0.37,y:-15.1,alpha:0.023},0).wait(1).to({regX:0,regY:-0.1,scaleX:0.35,scaleY:0.35,y:-16,alpha:0},0).wait(4));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-48,123.5,95.9,30.6);
...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({regX:101,regY:108.5,x:-56.7,y:109.5},0).wait(1).to({x:-10.8},0).wait(1).to({x:17.5},0).wait(1).to({x:36.4},0).wait(1).to({x:49.5},0).wait(1).to({x:58.7},0).wait(1).to({x:65.1},0).wait(1).to({x:69.4},0).wait(1).to({x:72.3},0).wait(1).to({x:74},0).wait(1).to({x:74.8},0).wait(1).to({regX:0,regY:0,x:-26,y:1},0).wait(72).to({regX:101,regY:108.5,scaleX:1,scaleY:1,x:75,y:109.6},0).wait(1).to({scaleX:1,scaleY:1,x:74.8,y:110},0).wait(1).to({scaleX:0.99,scaleY:0.99,x:74.5,y:110.8},0).wait(1).to({scaleX:0.98,scaleY:0.98,x:74,y:112},0).wait(1).to({scaleX:0.97,scaleY:0.97,x:73.2,y:113.8},0).wait(1).to({scaleX:0.95,scaleY:0.95,x:72.1,y:116.4},0).wait(1).to({scaleX:0.92,scaleY:0.92,x:70.5,y:120.2},0).wait(1).to({scaleX:0.87,scaleY:0.87,x:68.2,y:125.7},0).wait(1).to({scaleX:0.82,scaleY:0.82,x:65.1,y:132.8},0).wait(1).to({scaleX:0.77,scaleY:0.77,x:62.2,y:139.5},0).wait(1).to({scaleX:0.73,scaleY:0.73,x:60.4,y:143.9},0).wait(1).to({scaleX:0.71,scaleY:0.71,x:59.3,y:146.4},0).wait(1).to({scaleX:0.7,scaleY:0.7,x:58.8,y:147.6},0).wait(1).to({regX:-0.1,regY:0,scaleX:0.7,scaleY:0.7,x:-12,y:72},0).wait(176).to({regX:101,regY:108.5,x:58.7,y:146.8},0).wait(1).to({y:143.7},0).wait(1).to({regX:-0.1,regY:0.1,x:-12,y:67.1},0).wait(1).to({regX:101,regY:108.5,x:58.7,y:143.5,alpha:0.994},0).wait(1).to({y:145.1,alpha:0.975},0).wait(1).to({y:147.8,alpha:0.943},0).wait(1).to({y:151.7,alpha:0.897},0).wait(1).to({y:157,alpha:0.836},0).wait(1).to({y:163.7,alpha:0.757},0).wait(1).to({x:58.6,y:172.3,alpha:0.655},0).wait(1).to({y:183.5,alpha:0.524},0).wait(1).to({x:58.5,y:199,alpha:0.342},0).wait(1).to({regX:-0.7,regY:0.4,x:-12.5,y:152.3,alpha:0},0).to({_off:true},1).wait(115));
...
p.nominalBounds = new cjs.Rectangle(-880,-287.7,1981.8,571.5);


// stage content:
(lib.alfabank_cut8_tree_240x400_review = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(-170,112.3,1511.8,571.5);
// library properties:
lib.properties = {
	width: 240,
	height: 400,
