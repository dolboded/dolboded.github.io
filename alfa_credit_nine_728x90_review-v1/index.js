...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(119).to({_off:false},0).to({y:170},19,cjs.Ease.cubicOut).wait(71).to({startPosition:0},0).to({y:302.8},20,cjs.Ease.cubicIn).to({_off:true},1).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(11).to({_off:false},0).to({y:173},19,cjs.Ease.cubicOut).wait(74).to({startPosition:0},0).to({y:309},20,cjs.Ease.cubicIn).to({_off:true},1).wait(113));
...
// stage content:
(lib.alfa_credit_nine_728x90_reviewv1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
