...
lib.ssMetadata = [
		{name:"premr_territory_728x90_review_v3_atlas_", frames: [[0,92,728,90],[0,0,728,90]]}
];
...
(lib.BG2 = function() {
	this.initialize(ss["premr_territory_728x90_review_v3_atlas_"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.txt, new cjs.Rectangle(-1,-1,728,90), null);
...
// stage content:
(lib.premr_territory_728x90_reviewv3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"premr_territory_728x90_review_v3_atlas_.png", id:"premr_territory_728x90_review_v3_atlas_"}
	],
	preloads: []
};
