...
p.nominalBounds = new cjs.Rectangle(0,0,506,265);// helper functions:
...
(lib.txt101 = function(mode,startPosition,loop) {
	...
	// Layer 1 copy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EF3124").s().p("");
	this.shape.setTransform(-28.1,2.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.txt101, new cjs.Rectangle(-76,-23.3,128.3,46.7), null);
...
(lib.sheep = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(636,-288,1,1,0,0,180);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.sheep, new cjs.Rectangle(130,-288,506,265), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#FFFFFF","#D4E6F3"],[0,0.741],1,-1.9,0,1,-1.9,671.8).s().p("EhisAspMAAAhZRMDFZAAAMAAABZRg");
...
(lib.TXT1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regX:-28.1,regY:2.3,x:-28.1,y:54.7,alpha:0.536},0).wait(1).to({y:24.1,alpha:0.731},0).wait(1).to({y:6.5,alpha:0.843},0).wait(1).to({y:-4.5,alpha:0.914},0).wait(1).to({y:-11.4,alpha:0.957},0).wait(1).to({y:-15.4,alpha:0.983},0).wait(1).to({y:-17.5,alpha:0.996},0).wait(1).to({regX:0,regY:0,x:0,y:-20.4,alpha:1},0).wait(1).to({regX:-28.1,regY:2.3,x:-28.1,y:-17.6},0).wait(1).to({y:-15.9},0).wait(1).to({y:-14.1},0).wait(1).to({regX:0,regY:0,x:0,y:-16},0).wait(57).to({regX:-28.1,regY:2.3,scaleX:1,scaleY:1,x:-28.2,y:-13.7},0).wait(1).to({scaleX:1.02,scaleY:1.02,x:-28.8,y:-13.6},0).wait(1).to({scaleX:1.05,scaleY:1.05,x:-29.3},0).wait(1).to({regX:-0.1,regY:-0.1,scaleX:1.05,scaleY:1.05,x:-0.1,y:-16},0).wait(1).to({regX:-28.1,regY:2.3,scaleX:1.03,scaleY:1.03,x:-29,y:-13.5,alpha:0.977},0).wait(1).to({scaleX:0.98,scaleY:0.98,x:-27.4,y:-13.7,alpha:0.894},0).wait(1).to({scaleX:0.86,scaleY:0.86,x:-24.2,y:-13.9,alpha:0.733},0).wait(1).to({scaleX:0.7,scaleY:0.7,x:-19.6,y:-14.3,alpha:0.5},0).wait(1).to({scaleX:0.54,scaleY:0.54,x:-15.1,y:-14.7,alpha:0.267},0).wait(1).to({scaleX:0.42,scaleY:0.42,x:-11.9,y:-15,alpha:0.106},0).wait(1).to({scaleX:0.37,scaleY:0.37,x:-10.3,y:-15.1,alpha:0.023},0).wait(1).to({regX:0,regY:-0.1,scaleX:0.35,scaleY:0.35,x:0,y:-16,alpha:0},0).wait(4));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-76,123.5,95.9,30.6);
...
(lib.legalmov = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:-3.5,regY:-99,x:-3.5,y:-104.4,alpha:0.452},0).wait(1).to({y:-102.3,alpha:0.662},0).wait(1).to({y:-101.1,alpha:0.79},0).wait(1).to({y:-100.2,alpha:0.873},0).wait(1).to({y:-99.7,alpha:0.928},0).wait(1).to({y:-99.3,alpha:0.964},0).wait(1).to({y:-99.1,alpha:0.986},0).wait(1).to({y:-99,alpha:0.997},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:1},0).wait(76).to({regX:-3.5,regY:-99,x:-3.5,y:-99,alpha:0.995},0).wait(1).to({y:-98.8,alpha:0.981},0).wait(1).to({y:-98.5,alpha:0.954},0).wait(1).to({y:-98.1,alpha:0.912},0).wait(1).to({y:-97.5,alpha:0.852},0).wait(1).to({y:-96.7,alpha:0.766},0).wait(1).to({y:-95.4,alpha:0.642},0).wait(1).to({y:-93.5,alpha:0.446},0).wait(1).to({regX:0,regY:0,x:0,y:10,alpha:0},0).wait(2));
...
(lib.movie = function(mode,startPosition,loop) {
	...
	// SHEEP
	this.instance_3 = new lib.sheep();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-26,181);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({regX:383,regY:-155.5,x:357,y:-52.2},0).wait(1).to({y:-87.9},0).wait(1).to({y:-109.9},0).wait(1).to({y:-124.5},0).wait(1).to({y:-134.7},0).wait(1).to({y:-141.8},0).wait(1).to({y:-146.8},0).wait(1).to({y:-150.1},0).wait(1).to({y:-152.3},0).wait(1).to({y:-153.6},0).wait(1).to({y:-154.3},0).wait(1).to({regX:0,regY:0,x:-26,y:1},0).wait(72).to({regX:383,regY:-155.5,scaleX:1,scaleY:1,x:357.4,y:-154.5},0).wait(1).to({scaleX:1,scaleY:1,x:358.5},0).wait(1).to({scaleX:0.99,scaleY:0.99,x:360.7,y:-154.4},0).wait(1).to({scaleX:0.98,scaleY:0.98,x:364.1,y:-154.3},0).wait(1).to({scaleX:0.97,scaleY:0.97,x:369.2},0).wait(1).to({scaleX:0.95,scaleY:0.95,x:376.6,y:-154.2},0).wait(1).to({scaleX:0.92,scaleY:0.92,x:387.4,y:-154},0).wait(1).to({scaleX:0.87,scaleY:0.87,x:402.9,y:-153.7},0).wait(1).to({scaleX:0.82,scaleY:0.82,x:423,y:-153.4},0).wait(1).to({scaleX:0.77,scaleY:0.77,x:442,y:-153.2},0).wait(1).to({scaleX:0.73,scaleY:0.73,x:454.7,y:-153},0).wait(1).to({scaleX:0.71,scaleY:0.71,x:461.7,y:-152.8},0).wait(1).to({scaleX:0.7,scaleY:0.7,x:465},0).wait(1).to({regX:-0.1,regY:0,scaleX:0.7,scaleY:0.7,x:198,y:-44},0).wait(176).to({regX:383,regY:-155.5,x:466.1,y:-153.3},0).wait(1).to({y:-155.9},0).wait(1).to({regX:-0.1,regY:0.1,x:198,y:-47.9},0).wait(1).to({regX:383,regY:-155.5,x:466.1,y:-156.6,alpha:0.997},0).wait(1).to({y:-155.8,alpha:0.987},0).wait(1).to({y:-154.5,alpha:0.969},0).wait(1).to({y:-152.3,alpha:0.94},0).wait(1).to({y:-149.2,alpha:0.898},0).wait(1).to({x:466,y:-144.8,alpha:0.838},0).wait(1).to({y:-138.5,alpha:0.753},0).wait(1).to({y:-129.2,alpha:0.628},0).wait(1).to({x:465.9,y:-114.5,alpha:0.43},0).wait(1).to({regX:-0.7,regY:0.4,x:197.5,y:26.3,alpha:0},0).to({_off:true},1).wait(115));
	...
	this.instance_6.setTransform(205,-155);
...
p.nominalBounds = new cjs.Rectangle(-386.6,-665.7,1263.4,823.8);


// stage content:
(lib.alfabank_cut8_tree_728x90_review = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(97.4,-420.7,1263.4,823.8);
// library properties:
lib.properties = {
	width: 728,
	height: 90,
