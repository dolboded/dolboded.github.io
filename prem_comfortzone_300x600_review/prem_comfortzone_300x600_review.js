...
lib.ssMetadata = [
		{name:"prem_comfortzone_300x600_review_atlas_", frames: [[0,0,300,600],[302,0,300,600],[0,602,300,74]]}
];
...
(lib.BG = function() {
	this.initialize(ss["prem_comfortzone_300x600_review_atlas_"]);
	this.gotoAndStop(0);
...
(lib.PREM = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.prem();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.PREM, new cjs.Rectangle(0,0,300,74), null);
...
}).prototype = getMCSymbolPrototype(lib.FADE, new cjs.Rectangle(0,0,300,600), null);
...
(lib.movie = function(mode,startPosition,loop) {
	...
	// PREM
	this.instance_1 = new lib.PREM();
	this.instance_1.parent = this;
	this.instance_1.setTransform(150,523,1,1,0,0,0,150,37);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(25).to({_off:false},0).to({alpha:1},20).wait(1));
...
// stage content:
(lib.prem_comfortzone_300x600_review = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/prem_comfortzone_300x600_review_atlas_.png?1602903918717", id:"prem_comfortzone_300x600_review_atlas_"}
	],
	preloads: []
};
