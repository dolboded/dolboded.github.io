...
(lib.go_viral_320x300 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// btn
	this.instance = new lib.bigbtn();
	this.instance.setTransform(160,150);
	...
	// frame
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("A4/3bMAx/AAAMAAAAu3Mgx/AAAg");
	this.shape.setTransform(160,150);
	...
	// bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#012A70").s().p("A4/XbMAAAgu2MAx/AAAMAAAAu2g");
	this.shape_1.setTransform(160,150);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(159,149,322,302);
