...
(lib.movie = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},1).wait(170).to({_off:false,regY:0,y:160.7,alpha:0},0).wait(1).to({regX:-0.4,regY:0.9,x:-0.3,y:150,alpha:0.417},0).wait(1).to({y:144.1,alpha:0.627},0).wait(1).to({y:140.1,alpha:0.769},0).wait(1).to({y:137.3,alpha:0.87},0).wait(1).to({y:135.4,alpha:0.939},0).wait(1).to({y:134.2,alpha:0.982},0).wait(1).to({regX:-0.1,regY:0.1,x:0.1,y:132.7,alpha:1},0).wait(52).to({regX:-0.4,regY:0.9,x:-1.7,y:133.6},0).wait(1).to({x:-4.4},0).wait(1).to({regX:0,regY:0,x:-5.5,y:132.6},0).wait(1).to({regX:-0.4,regY:0.9,x:-3.8,y:133.6,alpha:0.989},0).wait(1).to({x:1.7,alpha:0.961},0).wait(1).to({x:10,alpha:0.917},0).wait(1).to({x:20.9,alpha:0.86},0).wait(1).to({x:34.5,alpha:0.79},0).wait(1).to({x:51,alpha:0.705},0).wait(1).to({x:71.1,alpha:0.601},0).wait(1).to({x:96,alpha:0.471},0).wait(1).to({x:129.2,alpha:0.299},0).wait(1).to({regX:0,regY:0,x:187.3,y:132.6,alpha:0},0).wait(9));

	// Regist
	this.instance_1 = new lib.txtHurry();
	this.instance_1.setTransform(0.6,114.9,1.17,1.17);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},1).wait(168).to({_off:false,y:142.9,alpha:0},0).wait(1).to({regX:-0.3,regY:1.2,x:0.2,y:132.6,alpha:0.417},0).wait(1).to({y:126.7,alpha:0.627},0).wait(1).to({y:122.7,alpha:0.769},0).wait(1).to({y:119.8,alpha:0.87},0).wait(1).to({y:117.9,alpha:0.939},0).wait(1).to({y:116.7,alpha:0.982},0).wait(1).to({regX:0,regY:0,x:0.6,y:114.9,alpha:1},0).wait(54).to({regX:-0.3,regY:1.2,x:-1.2,y:116.3},0).wait(1).to({x:-3.9},0).wait(1).to({regX:0,regY:0,x:-5,y:114.9},0).wait(1).to({regX:-0.3,regY:1.2,x:-3.3,y:116.3,alpha:0.989},0).wait(1).to({x:2.2,alpha:0.961},0).wait(1).to({x:10.6,alpha:0.917},0).wait(1).to({x:21.5,alpha:0.86},0).wait(1).to({x:35.1,alpha:0.79},0).wait(1).to({x:51.6,alpha:0.705},0).wait(1).to({x:71.6,alpha:0.601},0).wait(1).to({x:96.6,alpha:0.471},0).wait(1).to({x:129.8,alpha:0.299},0).wait(1).to({regX:0,regY:0,x:187.7,y:114.9,alpha:0},0).wait(9));

	// 16-18
	this.instance_2 = new lib.TXTOne();
	this.instance_2.setTransform(0.6,-55.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:true},1).wait(85).to({_off:false,y:-46.6},0).wait(78).to({regY:0.8,y:-44.6},0).wait(1).to({y:-42.3},0).wait(1).to({regY:0,y:-41.8},0).wait(1).to({regY:0.8,y:-41.4},0).wait(1).to({y:-42.4},0).wait(1).to({y:-43.9},0).wait(1).to({y:-45.7},0).wait(1).to({y:-47.8},0).wait(1).to({y:-49.8},0).wait(1).to({y:-51.6},0).wait(1).to({y:-53.2},0).wait(1).to({y:-54.2},0).wait(1).to({regY:0,y:-55.4},0).wait(60).to({regY:0.8,x:-0.6,y:-54.6},0).wait(1).to({x:-3},0).wait(1).to({regY:0,x:-4.2,y:-55.4},0).wait(1).to({regY:0.8,x:-2.4,y:-54.6,alpha:0.989},0).wait(1).to({x:2.3,alpha:0.961},0).wait(1).to({x:9.4,alpha:0.917},0).wait(1).to({x:18.7,alpha:0.86},0).wait(1).to({x:30.3,alpha:0.79},0).wait(1).to({x:44.4,alpha:0.705},0).wait(1).to({x:61.6,alpha:0.601},0).wait(1).to({x:82.9,alpha:0.471},0).wait(1).to({x:111.3,alpha:0.299},0).wait(1).to({regY:0,x:160.6,y:-55.4,alpha:0},0).wait(3));

	// Go Viral
	this.instance_3 = new lib.TXTtwo();
	this.instance_3.setTransform(0.6,-10.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({_off:true},1).wait(99).to({_off:false,y:6.4},0).wait(63).to({regY:-0.8,y:6.8},0).wait(1).to({y:9.1},0).wait(1).to({regY:0,y:11.2},0).wait(1).to({regY:-0.8,y:9.8},0).wait(1).to({y:8.2},0).wait(1).to({y:5.8},0).wait(1).to({y:2.9},0).wait(1).to({y:-0.3},0).wait(1).to({y:-3.5},0).wait(1).to({y:-6.5},0).wait(1).to({y:-8.9},0).wait(1).to({y:-10.5},0).wait(1).to({regY:0,y:-10.4},0).wait(59).to({regY:-0.8,x:-0.6,y:-11.2},0).wait(1).to({x:-2.9},0).wait(1).to({regY:0,x:-4.2,y:-10.4},0).wait(1).to({regY:-0.8,x:-2.4,y:-11.2,alpha:0.989},0).wait(1).to({x:2.3,alpha:0.961},0).wait(1).to({x:9.4,alpha:0.917},0).wait(1).to({x:18.8,alpha:0.86},0).wait(1).to({x:30.4,alpha:0.79},0).wait(1).to({x:44.5,alpha:0.705},0).wait(1).to({x:61.6,alpha:0.601},0).wait(1).to({x:83,alpha:0.471},0).wait(1).to({x:111.4,alpha:0.299},0).wait(1).to({regY:0,x:160.6,y:-10.4,alpha:0},0).wait(5));

	// pattern
	this.instance_4 = new lib.pattern();
	this.instance_4.setTransform(1.1,51,0.621,0.621,0,0,0,0.5,-7.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({_off:true},1).wait(69).to({_off:false,regY:-7.3,y:81.1},0).wait(92).to({regX:-0.1,regY:0.3,x:0.7,y:86.1},0).wait(1).to({y:86.7},0).wait(1).to({regX:0.5,regY:-7.4,x:1.1,y:82.3},0).wait(1).to({regX:-0.1,regY:0.3,x:0.7,y:86.2},0).wait(1).to({y:83.9},0).wait(1).to({y:80.4},0).wait(1).to({y:76.2},0).wait(1).to({y:71.5},0).wait(1).to({y:66.8},0).wait(1).to({y:62.6},0).wait(1).to({y:59},0).wait(1).to({y:56.6},0).wait(1).to({regX:0.5,regY:-7.4,x:1.1,y:51},0).wait(58).to({regX:-0.1,regY:0.3,x:-0.4,y:55.8},0).wait(1).to({x:-2.5},0).wait(1).to({regX:0.4,regY:-7.4,x:-3.3,y:51},0).wait(1).to({regX:-0.1,regY:0.3,x:-1.9,y:55.8,alpha:0.989},0).wait(1).to({x:2.3,alpha:0.961},0).wait(1).to({x:8.7,alpha:0.917},0).wait(1).to({x:17.1,alpha:0.86},0).wait(1).to({x:27.5,alpha:0.79},0).wait(1).to({x:40.2,alpha:0.705},0).wait(1).to({x:55.7,alpha:0.601},0).wait(1).to({x:74.9,alpha:0.471},0).wait(1).to({x:100.4,alpha:0.299},0).wait(1).to({regX:0.5,regY:-7.4,x:145.1,y:51,alpha:0},0).wait(7));

	// logo
	this.instance_5 = new lib.logo();
	this.instance_5.setTransform(0.4,-111.5,0.52,0.52,0,0,0,-0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},1).wait(66).to({_off:false},0).wait(171).to({regX:0,regY:-40.4,x:-0.8,y:-132.5},0).wait(1).to({x:-3.1},0).wait(1).to({regX:-0.1,regY:-0.1,x:-4.4,y:-111.5},0).wait(1).to({regX:0,regY:-40.4,x:-2.6,y:-132.5,alpha:0.989},0).wait(1).to({x:2.1,alpha:0.961},0).wait(1).to({x:9.2,alpha:0.917},0).wait(1).to({x:18.6,alpha:0.86},0).wait(1).to({x:30.2,alpha:0.79},0).wait(1).to({x:44.3,alpha:0.705},0).wait(1).to({x:61.4,alpha:0.601},0).wait(1).to({x:82.8,alpha:0.471},0).wait(1).to({x:111.2,alpha:0.299},0).wait(1).to({regX:-0.1,regY:-0.1,x:160.4,y:-111.5,alpha:0},0).wait(1));
...
(lib.go_viral_300x320 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// btn
	this.instance = new lib.bigbtn();
	this.instance.setTransform(150,160,0.938,1.067);
	...
	// frame
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("A3b4/MAu3AAAMAAAAx/Mgu3AAAg");
	this.shape.setTransform(150,160);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// movie
	this.instance_1 = new lib.movie();
	this.instance_1.setTransform(149,157,1.037,1.037);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#012A70").s().p("A3bZAMAAAgx/MAu2AAAMAAAAx/g");
	this.shape_1.setTransform(150,160);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(149,159,302,322);
