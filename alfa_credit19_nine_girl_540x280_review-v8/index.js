...
(lib.txt02_5 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#EF3124").s().p("");
	this.shape.setTransform(14.375,115.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer_1 copy
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#EF3124").s().p("AqTPcQhjhsg3iQQgziFgGiSIHFAAQAICGBHBjQBnCSDPgBQDcABB2iRQBoiAAAjOIAAgXQAAjKh3h/Qh7h/jIAAQihgBhuBRQhIAzgjBGImgAAIAA0nIYwAAIAAGFIyDAAIAAIlQBDhTB5g5QCMhCCgAAQCgAACOA6QCOA6BpBsQBtBwA5CXQA9CfAAC9IAAAbQAAC5g9ChQg+Chh1B5Qh3B7ikBDQisBFjMAAQmRAAjmj9g");
	this.shape_1.setTransform(2.025,1);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.txt02_5, new cjs.Rectangle(-148,-123.1,310.8,261.5), null);
...
(lib.txt01_percent = function(mode,startPosition,loop) {
	...
	// Layer_1 copy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EF3124").s().p("");
	...
	// Layer_2 copy
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#EF3124").s().p("");
	this.shape_1.setTransform(-266.975,12.15);
...
// stage content:
(lib.alfa_credit19_nine_girl_540x280_reviewv7 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
